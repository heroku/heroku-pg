...
function * run (context, heroku) {
  ...
  //TODO: this comment is lies, we should not be giving the addon name but the addon and namespace, or attachment
  yield cli.action(`Promoting ${cli.color.addon(attachment.addon.name)} to ${cli.color.configVar('DATABASE_URL')} on ${cli.color.app(app)}`, co(function * () {
